...
.pet-footer{{margin-top:2rem;padding-top:1rem;padding-bottom:3rem;border-top:1px solid var(--border);font-size:.72rem;color:var(--muted)}}
...
<div class="screen" id="screen-pet">
    ...
    <div class="xp-section">
        <div class="xp-label"><span id="xp-text">Stats</span><span id="xp-next">Total</span></div>
...
<div class="loot-overlay" id="loot-overlay">
    ...
    <div id="lr-compare" style="margin-top:.8rem;padding:.8rem;background:rgba(255,255,255,.04);border:1px solid var(--border);border-radius:10px;display:none;text-align:center"></div>
    <div class="loot-btns">
